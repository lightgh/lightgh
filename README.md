<!--
**lightgh/lightgh** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
* **Expertise:** Proficient in **Java, Spring Boot, Spring Framework,** and **JPA/Hibernate**, Python, React, Angular, Node.js, Nest.js, TypeScript, delivering robust web and mobile experiences.
* **Cloud Architectures:** Experienced in building distributed systems with **AWS (Lambda, API Gateway, DynamoDB, SNS, SQS, S3, EventBridge, VPC)**. **GCP (PubSub, Cloud Run, Cloud Funtions, Firestore)** and other cloud-native technologies.
...
![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=lightgh&layout=compact&theme=radical)
